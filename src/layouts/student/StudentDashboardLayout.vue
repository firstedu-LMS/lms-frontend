<template>
  <div class="flex justify-end">
    <aside v-if="sideBar" class="h-screen fixed top-0 left-0 border-r border-[#e2e8f0] z-50 bg-white pr-[12px] py-2">
    ...
    <div class="transition-all ease-in-out">
      <nav class="sticky top-0 flex justify-between w-full p-2 text-white shadow-lg bg-green">
