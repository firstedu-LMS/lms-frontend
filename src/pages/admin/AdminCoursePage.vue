    ...
    <div>
        <div class="flex justify-between text-white ">
            ...
            <div class="my-auto mr-6">
                <span @click="showTable" class="px-4 py-1 cursor-pointer"  :class="courseTable ? 'bg-blue-2' : 'bg-gray-2'">table</span>
                <span @click="showCreate" class="px-4 py-1 cursor-pointer " :class="courseCreate ? 'bg-blue-2': 'bg-gray-2' ">+ new</span>
            </div>
        </div>
        <div>
...
<script>
import CoursesView from '@/components/admin/courses/CoursesView.vue'
import CreateCourse from '@/components/admin/courses/CreateCourse.vue'
