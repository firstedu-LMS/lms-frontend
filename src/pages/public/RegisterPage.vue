<template>
    <div>
        ...
        <div class="flex justify-center mt-6 sm:items-center sm:mx-20 sm:shadow-xl">
            ...
            <form class="p-4 sm:w-1/3">
                <h1 class="text-2xl font-semibold text-center text-blue-2">Register Here</h1>
                <div class="px-4 py-2">
                    <label for="" class="text-sm font-semibold">Name</label>
                    <input required type="text" class="w-full mt-1 outline-none bg-transparent border px-2 py-0.5">
                </div>
                <div  class="px-4 py-2">
                    <label for="" class="text-sm font-semibold">Profile Picture</label>
                    <input required type="file" class="w-full mt-1 outline-none bg-transparent border px-2 py-0.5 file:bg-transparent file:border-0">
                </div>
                <div  class="px-4 py-2">
